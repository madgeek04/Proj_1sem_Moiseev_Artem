...
# регистра на верхний.
print(open('text18-15.txt').read())  # Выводим его содержимое
print(sum(map(str.islower, open('text18-15.txt').read())))  # Считаем и выводим количество букв в нижнем регистре
